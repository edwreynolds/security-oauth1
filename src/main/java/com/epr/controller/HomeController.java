...
public class HomeController {
	...
	private String getRepoInfo() {
		...
		// After a successful authentication with an external OAuth 2 service, the Authentication 
		// object kept in the security context is actually an OAuth2AuthenticationToken which, 
		// along with help from OAuth2AuthorizedClientService can avail us with an access token 
...
//		System.out.println(sb.toString());
		...
		//final String uri = "https://api.github.com/user/repos?access_token=" + accessToken;
